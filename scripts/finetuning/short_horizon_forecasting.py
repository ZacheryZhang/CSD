...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--init_lr", type=float, default=0.0003, help="Peak learning rate"
    )
    parser.add_argument(
        "--finetuning_mode", type=str, default="linear-probing", help="Finetuning mode"
    )
    parser.add_argument(
        "--max_epoch", type=int, default=20, help="Maximum number of epochs"
    )
    parser.add_argument(
        "--dataset_names",
        type=str,
